            ...
            <jsp:include page="navigation.jsp"></jsp:include>
                    ...
                    <ul class="select">
                        <p class="title font-normal">
                            <span class="fl">${twolevelname}</span>
                ...
                <div class="search-content">
                    ...
                    <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                        <c:forEach var="listpd" items="${listProductDisplay}">
                        <li>
                            <div class="i-pic limit">
                                <img src="${listpd.pictureurl}" />
                                <p class="title fl">${listpd.goodstitle}</p>
                                <p class="price fl">
                                    <b>¥</b>
                                    <strong>${listpd.goodsprice}</strong>
                                </p>
                                <p class="number fl">
                                    销量<span>${listpd.goodssalenum}</span>
                                </p>
                            </div>
                        </li>
                        </c:forEach>
